...
import com.example.compose.jetsurvey.survey.PosibleRespuesta.Action
import com.example.compose.jetsurvey.survey.PosibleRespuesta.MultipleChoice
import com.example.compose.jetsurvey.survey.PosibleRespuesta.SingleChoice
...
private val jetpackQuestions = mutableListOf(
    ...
    Pregunta(
        ...
        answer = PosibleRespuesta.SingleChoiceIcon(
    ...
    Pregunta(
        ...
        answer = PosibleRespuesta.Slider(
            range = 1f..10f,
            steps = 3,
...
private val jetpackSurvey = Encuesta(
    title = R.string.which_jetpack_library,
    preguntas = jetpackQuestions
)

object EncuestaRepository {
