...
fun SurveyQuestionsScreen(
    questions: EncuestaState.Questions,
    ...
    Surface(modifier = Modifier.supportWideScreen()) {
        Scaffold(
            ...
            content = { innerPadding ->
                Question(
                    pregunta = questionState.pregunta,
...
@Composable
private fun SurveyResult(result: EncuestaState.Result, modifier: Modifier = Modifier) {
